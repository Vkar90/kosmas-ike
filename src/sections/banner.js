...
import windTourbines from 'assets/wind-tourbines.jpg'
      ...
      <Container sx={styles.container}>
        <Grid sx={styles.grid}>
          <Box sx={styles.content}>
            ...
            <Text as="p">
            Discover more about the future of energy and its impact on your business. 
            </Text>
            ...
            <Box sx={styles.partner}>
              <Text as="span">Contact Info:</Text>
              <Box as="div">
                <h5 style={{ color:'#F64F5A'}}><a href="mailto:Emm.kosmas@gmail.com" target={'_blank'}>email</a></h5>
              </Box>
              <Box as="div">
                <h5 style={{ color:'#F64F5A'}}><a href="tel:+306977717825" target={'_blank'}>phone</a></h5>
              </Box>
              <Box as="div">
                <h5 style={{ color:'#F64F5A'}}><a href="https://goo.gl/maps/MpNTwzB7BBDKGc6v5" target={'_blank'}>address</a></h5>
              </Box>
            </Box>
          </Box>
          <Box sx={styles.image}>
            <Image src={windTourbines} width={'800px'} alt="" />
          </Box>
        </Grid>
      </Container>
    </Box>
